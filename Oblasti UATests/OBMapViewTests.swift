...
class OBMapViewTests: XCTestCase {
    
    // Tested Values
    var mapView: OBMapView!
    ...
    override func setUp() {
        ...
        mapView = OBMapView(frame: mapViewFrame, sublayerNamesAndPaths: sublayersNamePathDict)
    }
    ...
    func test_MapViewInit_WithEmptySublayerNamesAndPathsDict_HasNoSublayers() {
        let mapViewWithEmptyDict = OBMapView(frame: CGRect(origin: CGPoint.zero, size: CGSize(width: 910, height: 600)), sublayerNamesAndPaths: [:])
